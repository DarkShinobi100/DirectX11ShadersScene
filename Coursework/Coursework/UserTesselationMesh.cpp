...
UserTesselationMesh::UserTesselationMesh(ID3D11Device* device, ID3D11DeviceContext* deviceContext, int x, int y, int lresolution)
{
...
// Release resources.
UserTesselationMesh::~UserTesselationMesh()
{
...
void UserTesselationMesh::initBuffers(ID3D11Device* device)
{
	VertexType* vertices;
...
void UserTesselationMesh::sendData(ID3D11DeviceContext* deviceContext, D3D_PRIMITIVE_TOPOLOGY top)
{
	unsigned int stride;
	unsigned int offset;
