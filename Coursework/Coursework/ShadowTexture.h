//shader for generating and shadowing textured geometry
#ifndef _SHADOWTEXTURE_H_
#define _SHADOWTEXTURE_H_
...
class ShadowTexture : public BaseShader
{
private:
...
public:
	...
	ShadowTexture(ID3D11Device* device, HWND hwnd);
	~ShadowTexture();
